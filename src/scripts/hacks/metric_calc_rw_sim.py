...
file_path_csv = 'data/graphs/kw29/bigdata/metric/randomwalk.csv'
...
# find all graphs
sampling_strat = 'randomwalk'
path_to_true = 'data/graphs/kw29/bigdata/true/{}.graph'
path_all_randomwalk = 'data/graphs/kw29/bigdata/sim/randomwalk/'

true_ann = []
directory : str
for directory, sub_directories, files in os.walk(path_all_randomwalk):
