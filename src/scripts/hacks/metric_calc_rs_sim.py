...
file_path_csv = 'data/graphs/kw29/bigdata/metric/randomsampling.csv'
...
# find all graphs
sampling_strat = 'randomsampling'
path_to_true = 'data/graphs/kw29/bigdata/true/{}.graph'
path_all_randomsampling = 'data/graphs/kw29/bigdata/sim/randomsampling/'

true_ann = []
directory : str
for directory, sub_directories, files in os.walk(path_all_randomsampling):
