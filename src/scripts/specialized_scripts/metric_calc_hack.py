...
metric_runner = MetricRunner(name='Random Sampling', info=current_time)

# entropy metrics
metric_runner.add_simple_metric(am.entropy_clustered, {})\
    .add_comparison_metric(acm.stripped_entropy, {})\
...
metric_runner.add_simple_metric(am.entropy_clustered_normalized, {})\
    .add_comparison_metric(acm.stripped_entropy_normalized, {})\
...
#jsd with normalized
metric_runner.add_comparison_metric(acm.jsd_approximation_entropy_normalized, {})\
    .add_comparison_metric(acm.jsd_approximation_kld_normalized, {})\
    .add_comparison_metric(acm.jsd_approximation_apd_normalized, {'sample_size': 500})\
    .add_comparison_metric(acm.jsd_approximation_hpd_normalized, {'sample_size': 500})
...
ann_graphs = [
    [
        ['data/graphs/sim_graphs/randomsampling/sim_ks_loghard/2021_07_09_15_28/intermediate/k1'],
        ['data/graphs/sim_graphs/randomsampling/sim_ks_loghard/2021_07_09_15_28/intermediate/k3'],
        ['data/graphs/sim_graphs/randomsampling/sim_ks_loghard/2021_07_09_15_28/intermediate/k5'],
        ['data/graphs/sim_graphs/randomsampling/sim_ks_loghard/2021_07_09_15_28/intermediate/k10']
    ], [
        ['data/graphs/sim_graphs/randomsampling/sim_ks_logsoft/2021_07_09_15_27/intermediate/k1'],
        ['data/graphs/sim_graphs/randomsampling/sim_ks_logsoft/2021_07_09_15_27/intermediate/k3'],
        ['data/graphs/sim_graphs/randomsampling/sim_ks_logsoft/2021_07_09_15_27/intermediate/k5'],
        ['data/graphs/sim_graphs/randomsampling/sim_ks_logsoft/2021_07_09_15_27/intermediate/k10']
    ]
]
...
for _ in it:
    _cl = new_correlation_clustering(ann_graphs[it.multi_index], {'weights': 'edge_soft_weight',  'split_flag': False})
    # _cl = new_correlation_clustering(ann_graphs[it.multi_index], {'weights': 'edge_soft_weight',  'split_flag': True})
...
out_metric = 'data/graphs/sim_graphs/randomsampling/metric_norm_run/wo_island/{}'.format(current_time)
# out_metric = 'data/graphs/sim_graphs/randomsampling/metric_norm_run/island/{}'.format(current_time)
