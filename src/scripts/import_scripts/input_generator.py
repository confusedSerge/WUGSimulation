...
def _gen_dict_object(id_: str, sentence1: list, sentence2: list) -> dict:
    ...
    return {"id": id_, "lemma": sentence1[0], "pos": pos, "sentence1": sentence1[2], "sentence2": sentence2[2],
            "start1": str(sentence1[3]), "end1": str(sentence1[4]), "start2": str(sentence2[3]), "end2": str(sentence2[4])}
