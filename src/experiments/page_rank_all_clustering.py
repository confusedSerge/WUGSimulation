...
def pagerank_sim(graph_path: str, rounds: int, annotations_per_edge: int):
    ...
    for i, (name, path) in enumerate(paths_to_true):
        for _round in range(rounds):
            ...
            # Sampler/s
            sampling_step = Sampling(annotations_per_edge=annotations_per_edge).add_sampling_strategie(page_rank, {'sample_size': int(10 / annotations_per_edge), 'start': annotated_graph.get_last_added_node, 'tp_coef': 0.1})\
            ...
            name_metric_rs = '{}-{}-{}-pagerank_cc_split'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            name_metric_rs_judgement = '{}-{}-{}-pagerank_cc_split_j'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            ...
            name_metric_rs = '{}-{}-{}-pagerank_cc_nosplit'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            name_metric_rs_judgement = '{}-{}-{}-pagerank_cc_nosplit_j'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            ...
            name_metric_rs = '{}-{}-{}-pagerank_ccc'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            name_metric_rs_judgement = '{}-{}-{}-pagerank_ccc_j'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            ...
            name_metric_rs = '{}-{}-{}-pagerank_cw'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            name_metric_rs_judgement = '{}-{}-{}-pagerank_cw_j'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            ...
            name_metric_rs = '{}-{}-{}-pagerank_sbm'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
            name_metric_rs_judgement = '{}-{}-{}-pagerank_sbm_j'.format(name.replace(file_suffix, ''), _round + 1, annotations_per_edge)
...
if __name__ == '__main__':
    pagerank_sim(sys.argv[1], int(sys.argv[2]), int(sys.argv[3]))
