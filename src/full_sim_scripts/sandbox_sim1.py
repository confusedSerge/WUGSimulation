...
for edge_found in edges:
    print('started sim')
    true_wug, simulation_wug, max_iter_flag = simulation(true_wug, simulation_wug, max_iter=500,
                        sampling_strategy=page_rank, sampling_params={'sample_size': 10, 'start': simulation_wug.get_last_added_node, 'tp_coef': 1.0},
